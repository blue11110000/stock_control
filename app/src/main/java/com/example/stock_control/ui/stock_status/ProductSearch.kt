...
class ProductSearch : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        StockListViewModel.productList.observe(this) { productList ->
            binding.recycleView.adapter =
                RecyclerCardAdapter(productList.toMutableList(),CardType.PRODUCT_SEARCH)
        }
        ...
        binding.searchView.setOnQueryTextListener(object : SearchView.OnQueryTextListener{
            override fun onQueryTextSubmit(productName: String?): Boolean {
                ...
                viewModel.findProductName(productName)
